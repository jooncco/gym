...
public class Solution {
	...
	private int findNumberOfSchemes(int members, int idx, int profitNeeded) {
		...
		if (cache[members][idx][profitNeeded] > -1)
			return cache[members][idx][profitNeeded];

		cache[members][idx][profitNeeded] = 0;
		cache[members][idx][profitNeeded] = add(cache[members][idx][profitNeeded],
				findNumberOfSchemes(members, idx + 1, profitNeeded));
