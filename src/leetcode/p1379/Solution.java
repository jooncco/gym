...
public class Solution {
    ...
    private boolean isIdentical(final TreeNode curRoot, final TreeNode target) {
        if (curRoot == null && target == null) return true;
        if (curRoot == null || target == null) return false;
    ...
    private TreeNode findClonedTarget(final TreeNode currentClonedNode, final TreeNode target) {
        if (currentClonedNode == null) return null;

        if (isIdentical(currentClonedNode, target)) return currentClonedNode;
